...
public class ViewRecycleToolsAdapter extends RecyclerView.Adapter<ViewRecycleToolsAdapter.ViewHolder> {
    private ArrayList<Tool> data;
    ...
    public ViewRecycleToolsAdapter(Context con, ArrayList<Tool> data, String fragment_Name) {
        this.context = con;
        this.data = data;
    ...
    public ViewRecycleToolsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.product_container, parent, false);
        return new ViewRecycleToolsAdapter.ViewHolder(view);
    }

    public void onBindViewHolder(ViewRecycleToolsAdapter.ViewHolder holder, int position) {
